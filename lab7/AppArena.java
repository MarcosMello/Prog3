...
public class AppArena {
    ...
    public enum dadosBases{
        GLADIADOR (100, 20, 50),
        LUTADOR (200, 40, 60);

        private final int nivelEnergiaBase;
        private final int danoBase;
        private final int poderDefesaBase;

        dadosBases(int nivelEnergiaBase, int danoBase, int poderDefesaBase){
            this.nivelEnergiaBase = nivelEnergiaBase;
            this.danoBase = danoBase;
            this.poderDefesaBase = poderDefesaBase;
        }

        public int nivelEnergiaBase(){
            return nivelEnergiaBase;
        }
        public int danoBase(){
            return danoBase;
        }
        public int poderDefesaBase(){
            return poderDefesaBase;
        }
    }
